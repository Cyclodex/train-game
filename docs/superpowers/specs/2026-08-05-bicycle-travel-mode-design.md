...
body against `stallLengthPx · 0.98` and 16px refuses it. Phases C′ (citizen
travel mode) and D (shared paths) remain plans. The rest of this document is the impact survey and
