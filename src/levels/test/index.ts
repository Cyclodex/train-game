...
export const DOMAINS: ScenarioDomain[] = [
  {
    ...
    categories: [
      ...
      { id: "stations", label: "Stations", scenarios: [station, boarding, catchment, parkandride, busfeeder, threecities, citizencars, citizenwalk, citizenzebra, citizenrail, citizenchoice] },
      {
        id: "crossings",
        label: "Crossings",
