...
export const DOMAINS: ScenarioDomain[] = [
  ...
  },
  {
    ...
    categories: [
      ...
      { id: "worlds", label: "Worlds", scenarios: [terrain, farmland, bridge, tunnel, clearing, backdroptrees, townscape, industry, forestworld, lakevalley, lakevalleyOpen, demoworld, parkcity] },
    ],
  },
];
