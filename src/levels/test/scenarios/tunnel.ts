...
//  2. **The train vanishes at the portal.** Nothing is switched off: the bore's
//     mountain renders ABOVE the trains (TileGround's `.tile-over-bore` roof,
//     the same trick as the forest canopy) and the portal mouth stands out over
//     the open ground, so each unit slides behind the rock face and back out
//     again continuously. Watch the nose enter the black — it goes in gradually.
